...
- Rahmen der Fotos einstellbar: runde/kantige Ecken, Passepartout (0–14 px, Posterfarbe mit Haarlinie) mit optionalen Eckmarken (Postkarten-Look), ausgefranster Rand (0–10 px, SVG-Rauschmaske – am Bildschirm als CSS-Maske, im Export per `destination-in`). Bildunterschrift und Nummer liegen innerhalb der Maske.
